  ...
  return (
    ...
    >
      <div
        ...
        `}
      >
        <Core.Text customSize="25px">E-Prescription Template</Core.Text>
      </div>
      <div
        css={`
          display: grid;
...
function Header({
  ...
  const [color, setColor] = useState(prescriptionTemplateColor || Colours.teal)
  // eslint-disable-next-line
  useEffect(() => {
    if (!showColorPicker) setColor(prescriptionTemplateColor)
  })
  return (
    <>
      {showColorPicker && (
