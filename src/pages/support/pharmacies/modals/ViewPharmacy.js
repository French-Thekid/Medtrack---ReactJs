  ...
  >
    ...
    >
      ...
      <div
        ...
        `}
      >
        <Core.Text color={Colours.textGrey}>Pharmacy ID:</Core.Text>
        <Core.Text>{organisationId}</Core.Text>
        <Core.Text color={Colours.textGrey}>Pharmacy Email:</Core.Text>
        <Core.Text>{organisationEmail}</Core.Text>
        <Core.Text color={Colours.textGrey}>Pharmacy Tax-ID:</Core.Text>
