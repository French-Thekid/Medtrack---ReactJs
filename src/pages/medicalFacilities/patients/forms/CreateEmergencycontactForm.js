...
import { CREATE_EMERGENCY_CONTACT } from '../mutations'
import { LIST_EMERGENCY_CONTACT } from '../queries'

import { FormControl, Core, Content, Loading } from 'components'

function CreateEmergencycontactForm({ close, showNotificationCreate }) {
  ...
  const [
    ...
    { loading, error: createEmergencyContactFailed },
  ] = useMutation(CREATE_EMERGENCY_CONTACT, {
    refetchQueries: () => [
      {
    ...
    onCompleted(createEmergencyContact) {
      if (showNotificationCreate) showNotificationCreate()
    },
  })
        ...
        await createEmergencyContact({
          variables: {
            emergencyContact: {
              ...
              patientPersonId: parseInt(patientPersonId),
            },
          },
        ...
        return (
          <form onSubmit={handleSubmit}>
            ...
            {createEmergencyContactFailed && (
              <Content.Alert
                type="error"
                message="Fail to add new Emergency Contact"
              />
            )}
...
export default CreateEmergencycontactForm
